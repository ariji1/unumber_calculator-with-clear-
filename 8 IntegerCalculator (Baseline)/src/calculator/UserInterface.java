...
//	private int unit1Index;
//	private int unit2Index;
	...
	private TextFlow errMeasuredValue4;
	 ...
	 boolean boolUpdatingComboBox1 = true;
	    ...
	    int selectlistState1 = 0;
	    String stringDefaultItem = "";
	    String stringDefaultItem1 = "";
...
//	    private SelectList unit_list = new SelectList();
	    ...
	    ObservableList<String> arrayCountries = FXCollections.observableArrayList("-- no unit selected --","meter","kilometer",
	    		"feet","seconds","minutes","hours",
	    		"grams","pounds","kilograms","mps","kmph",
	    		"mps2","kmph2","Newton","Dyne","m3kg-1s-2","m2","km2","feet2","kg.m.s-1","g.cm.s-1","s2","m1/2");
	...
	**********************************************************************************************/
	...
	public UserInterface(Pane theRoot) {
		...
		// Label theScene with the name of the calculator, centered at the top of the pane
				setupLabelUI(label_DoubleCalculator, "Calibri", 24, Calculator.WINDOW_WIDTH, Pos.CENTER, 0, 14);
				label_DoubleCalculator.setTextFill(Color.web("#e5f1f5"));
				// Label the first operand just above it, left aligned
				setupLabelUI(label_Operand1, "Arial", 24, Calculator.WINDOW_WIDTH+30, Pos.BASELINE_LEFT, 20, 50);
				label_Operand1.setTextFill(Color.web("#e5f1f5"));
				// Label the first operand just above it, right aligned
				setupLabelUI(label_Operand1ErrorTerm, "Arial", 24, Calculator.WINDOW_WIDTH-140, Pos.BASELINE_LEFT,670, 50);
				label_Operand1ErrorTerm.setTextFill(Color.web("#e5f1f5"));
				...
				setupTextUI(text_Operand1, "Arial", 24, Calculator.WINDOW_WIDTH-900, Pos.BASELINE_LEFT, 10, 80, true);
				...
				// Establish the first text input error operand field and when anything changes in error operand 1,
						// process both fields to ensure that we are ready to perform as soon as possible.
				setupTextUI(text_Operand1ErrorTerm, "Arial", 24, 500, Pos.BASELINE_LEFT, Calculator.WINDOW_WIDTH/2-80, 80, true);
				...
				label_errOperand1.setTextFill(Color.web("#f5e5f1"));
				
				// Establish an error message for the first error operand just above it with, left aligned
				setupLabelUI(error_term1, "Arial", 14, Calculator.WINDOW_WIDTH, Pos.BASELINE_LEFT, 680, 140); // Label initialization for errorterm1
				error_term1.setTextFill(Color.web("#f5e5f1"));
				 
				setupLabelUI(label_unit1, "Arial", 24,Calculator.WINDOW_WIDTH-60,Pos.BASELINE_LEFT ,1200, 50);
				label_unit1.setTextFill(Color.web("#e5f1f5"));
				/* This block Establishes the two moving parts of the error message for Operand1 and err_Operand1 */
				errMVPart1.setFill(Color.RED);
				...
				errMeasuredValue3.setLayoutX(688);  
				...
				label_Operand2.setTextFill(Color.web("#e5f1f5"));
				//Label the second error operand just above it, right aligned
				setupLabelUI(label_Operand2ErrorTerm, "Arial", 24, Calculator.WINDOW_WIDTH-120, Pos.BASELINE_LEFT, 670, 175);
				label_Operand2ErrorTerm.setTextFill(Color.web("#e5f1f5"));
				// Establish the second text input operand field and when anything changes in operand 2,
				// process both fields to ensure that we are ready to perform as soon as possible.
				setupTextUI(text_Operand2, "Arial", 24, Calculator.WINDOW_WIDTH-900, Pos.BASELINE_LEFT, 10, 205, true);
				...
				// process both fields to ensure that we are ready to perform as soon as possible.
				setupTextUI(text_Operand2ErrorTerm, "Arial", 24, 500, Pos.BASELINE_LEFT, Calculator.WINDOW_WIDTH/2-80, 205, true);
				...
				setupLabelUI(error_term2, "Arial", 14, Calculator.WINDOW_WIDTH, Pos.BASELINE_LEFT, 680, 267);
				error_term2.setTextFill(Color.RED);
				
				
				setupLabelUI(label_unit2, "Arial", 24,Calculator.WINDOW_WIDTH-60,Pos.BASELINE_LEFT ,1200, 175);
				label_unit2.setTextFill(Color.LIGHTYELLOW);;
				...
				label_Result.setTextFill(Color.web("#7fd1bf"));
				
				// Label the result just above the error result output field, right aligned
				setupLabelUI(label_ResultErrorTerm, "Arial", 24, Calculator.WINDOW_WIDTH-160, Pos.BASELINE_LEFT, 670, 300);
				label_ResultErrorTerm.setTextFill(Color.web("#7fd1bf"));
				
				setupLabelUI(label_resultUnits, "Arial", 24,Calculator.WINDOW_WIDTH-60,Pos.BASELINE_LEFT ,1200, 300);
				label_resultUnits.setTextFill(Color.web("#f5e5e9"));
				...
				setupTextUI(text_Result, "Arial", 24, Calculator.WINDOW_WIDTH-900, Pos.BASELINE_LEFT, 10, 330, false);
				
				// Establish the result error output field.  It is not editable, so the text can be selected and copied, 
				// but it cannot be altered by the user.  The text is left aligned.
				setupTextUI(text_ResultErrorTerm, "Arial", 24, 500, Pos.BASELINE_LEFT, Calculator.WINDOW_WIDTH/2-80, 330, false);
				
				setupTextUI(text_ResultUnit, "Arial", 24, Calculator.WINDOW_WIDTH-1250, Pos.BASELINE_LEFT, 1200, 330, false);
				// Establish an error message for the result operand just above it with, left aligned
				setupLabelUI(label_errResult, "Arial", 18, Calculator.WINDOW_WIDTH-10, Pos.BASELINE_LEFT, 400, 400); // Label initialization for Operand 1 
				label_errResult.setTextFill(Color.LIGHTYELLOW);
				...
				result_error.setTextFill(Color.YELLOW);
				...
				errMVPart3.setFill(Color.WHEAT);
				...
				errETPart3.setFill(Color.WHEAT);
				...
				errMeasuredValue4.setLayoutX(688);  
				...
				comboboxSelectunit.setOnAction((event) ->{ if(!boolUpdatingComboBox)selectItem(); });
				comboboxSelectunit.setPrefWidth(250);
				comboboxSelectunit.setMinHeight(42);
				comboboxSelectunit.setLayoutX(1200);
				...
				comboboxSelectunit1.setOnAction((event) -> {if (!boolUpdatingComboBox1) selectItem1(); });
				comboboxSelectunit1.setPrefWidth(250);
				comboboxSelectunit1.setMinHeight(42);
				comboboxSelectunit1.setLayoutX(1200);
		...
		setupButtonUI(button_Add, "Symbol", 32, BUTTON_WIDTH, Pos.BASELINE_LEFT, 1 * buttonSpace-BUTTON_OFFSET, 470);
		button_Add.setOnAction((event) -> { addOperands(); addOperands_err(); });
		setupButtonUI(button_clr, "Symbol", 32, BUTTON_WIDTH, Pos.BASELINE_LEFT, 6 * buttonSpace-BUTTON_OFFSET, 470);
		button_clr.setOnAction((event) -> { clrOperands();});
		
		// Establish the SUB "-" button, position it, and link it to methods to accomplish its work
		setupButtonUI(button_Sub, "Symbol", 32, BUTTON_WIDTH, Pos.BASELINE_LEFT, 2 * buttonSpace-BUTTON_OFFSET, 470);
		...
		setupButtonUI(button_Mpy, "Symbol", 32, BUTTON_WIDTH, Pos.BASELINE_LEFT, 3 * buttonSpace-BUTTON_OFFSET, 470);
		...
		setupButtonUI(button_Div, "Symbol", 32, BUTTON_WIDTH, Pos.BASELINE_LEFT, 4 * buttonSpace-BUTTON_OFFSET, 470);
		...
		setupButtonUI(button_sqrt, "Symbol", 32, BUTTON_WIDTH, Pos.BASELINE_LEFT, 5 * buttonSpace-BUTTON_OFFSET, 470);
		...
		theRoot.getChildren().addAll(label_DoubleCalculator, label_Operand1,label_Operand1ErrorTerm, text_Operand1,text_Operand1ErrorTerm, label_errOperand1, error_term1,label_unit1,
				...
				button_clr,button_Add, button_Sub, button_Mpy, button_Div,button_sqrt,errMeasuredValue1,errMeasuredValue2,errMeasuredValue3,errMeasuredValue4,comboboxSelectunit,comboboxSelectunit1);//added button_square root for sqare_root button
...
//		}
	...
	private void addOperands(){
		...
		label_errOperand2.setText(""); 
		label_errOperand1.setText("");
//		text_ResultUnit.setText(unit1.getResultantUnitAfterAddition(unit2).toString());
		...
		if (theAnswer.length() > 0) {								// Check the returned String to see if it is okay
			...
			perform.setOperand1PreviousValue(unit1.getMetricMultiplier());
			perform.setOperand2PreviousValue(unit2.getMetricMultiplier());
		}
...
//		text_Result.setText("");
        ...
        // It is to clear the text for error message at operand2
			...
			// If the operands are defined and valid, request the business logic method to do the addition and return the
			// result as a String. If there is a problem with the actual computation, an empty string is returned
			perform.seterrOperand1WithConversion(unit1.getMetricMultiplier());
			perform.seterrOperand2WithConversion(unit2.getMetricMultiplier());
			...
			perform.seterrOperand1PreviousValue(unit1.getMetricMultiplier());
			perform.seterrOperand2PreviousValue(unit2.getMetricMultiplier());
			}
			else {														// Some error occurred while doing the addition.
	...
	private void subOperands(){
		...
		// Check to see if both operands are defined and valid
				...
				text_ResultUnit.setText(unit1.getResultantUnitAfterSubtraction(unit2).toString());
				perform.setOperand1WithConversion(unit1.getMetricMultiplier());
				perform.setOperand2WithConversion(unit2.getMetricMultiplier());
				label_errOperand2.setText(""); 
				label_errOperand1.setText("");
...
//				label_errResult.setText("Units not compatable for addition");
	...
	private void mpyOperands(){
		...
		// Check to see if both operands are defined and valid
				...
				text_ResultUnit.setText(unit1.getResultantUnitAfterMultiplication(unit2).toString());
				perform.setOperand1WithConversion(unit1.getMetricMultiplier());
				perform.setOperand2WithConversion(unit2.getMetricMultiplier());
				label_errOperand2.setText(""); 
				label_errOperand1.setText("");
...
//				label_errResult.setText("Units not compatable for multiplication");
	...
	private void divOperands(){
		...
		text_ResultUnit.setText(unit1.getResultantUnitAfterDivision(unit2).toString());
		System.out.println(unit1.getResultantUnitAfterDivision(unit2).toString());
		perform.setOperand1WithConversion(unit1.getMetricMultiplier());
		perform.setOperand2WithConversion(unit2.getMetricMultiplier());
		label_errOperand2.setText(""); 
		label_errOperand1.setText("");
...
//		error_term2.setText("");
	...
	private void sqrtOperands(){
		...
		if(!unit1.checkforsqrt()) {
			text_Result.setText("");
			text_ResultErrorTerm.setText("");
			label_errResult.setText("Units not compatable for Square_root");
			return;
		}
		text_ResultUnit.setText(unit1.getResultUnitAfterSquareroot().toString());
		perform.seterrOperand1WithConversion(unit1.getMetricMultiplier());
...
//		String theSelectedItem = (String) comboboxSelectunit.getSelectionModel().getSelectedItem();
		...
		unit1 = new unit(theSelectedIndex);
...
//		String theSelectedItem = (String) comboboxSelectunit1.getSelectionModel().getSelectedItem();
		...
		unit2 = new unit(theSelectedIndex);
//		System.out.println(theSelectedItem);
		return theSelectedIndex;
...
//    		System.out.println(stringDefaultItem);
...
//    		System.out.println(stringDefaultItem);
	...
	private void loadComboBoxData1() {
    	...
    	default:
    		stringDefaultItem1 = "";
    		System.out.println(stringDefaultItem1.toString());
    		comboboxSelectunit1.getItems().addAll(arrayCountries);
    		System.out.println(stringDefaultItem1);
    		break;
    	}
