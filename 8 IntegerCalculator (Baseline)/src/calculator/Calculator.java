...
//		final String SHALLOT_IMAGE_URL = "http://upload.wikimedia.org/wikipedia/commons/8/83/JWW_TheLadyOfShallot_1888.jpg";
...
//		Image image = new Image("cloud.jpg");
...
//		theRoot.setStyle("-fx-background-color: #A2A3A4;");
		
		
		BackgroundImage myBI= new BackgroundImage(new Image("cool-night-sky-stars-wallpaper-2560x1600-WTG200415315.jpg",WINDOW_WIDTH,WINDOW_HEIGHT,false,true),
		        BackgroundRepeat.REPEAT, BackgroundRepeat.NO_REPEAT, BackgroundPosition.DEFAULT,
		          BackgroundSize.DEFAULT);
		theRoot.setBackground(new Background(myBI));
		
//		theRoot.setBackground(img);
