...
//	    private SelectList unit_list = new SelectList();
	    ...
	    ObservableList<String> arrayCountries = FXCollections.observableArrayList("-- no unit selected --","meter","kilometer",
	    		...
	    		"mps2","kmph2","Newton","Dyne","m3kg-1s-2","m2","km2","feet2","kg.m.s-1","g.cm.s-1");
	...
	**********************************************************************************************/
	...
	public UserInterface(Pane theRoot) {
		...
		// Label theScene with the name of the calculator, centered at the top of the pane
				...
				errMVPart1.setFill(Color.ANTIQUEWHITE);
			    errMVPart1.setFont(Font.font("Arial", FontPosture.REGULAR, 20));
			    errMVPart2.setFill(Color.ANTIQUEWHITE);
				...
				errETPart1.setFill(Color.ANTIQUEWHITE);
			    errETPart1.setFont(Font.font("Arial", FontPosture.REGULAR, 20));
			    errETPart2.setFill(Color.ANTIQUEWHITE);
			    ...
			    errMVPart4.setFill(Color.LIGHTYELLOW);
			    ...
			    errETPart4.setFill(Color.LIGHTYELLOW);
...
//		String theSelectedItem = (String) comboboxSelectunit.getSelectionModel().getSelectedItem();
	...
	private int selectCountryItem1() {
		// There are two cases depending on where a previously selected list items have been selected
