...
//			int noOfDecimalsET = err_operand1.toString().length()-err_operand1.getCharacteristic();
...
//		}
		String getOperand1MeasuredValue()
		{
			return operand1.measuredValue+"";
		}
		String getOperand2MeasuredValue()
		{
			return operand2.measuredValue+"";
		}

		String geterrorterm1MeasuredValue()
		{
			return err_operand1.measuredValue+"";
		}

		String geterrorterm2MeasuredValue()
		{
			return err_operand2.measuredValue+"";
		}
		...
		{
			System.out.println("setOperand1WithConversion: "+metricMultiplier);
			operand1.convertMeasuredValue(metricMultiplier);
		}
		void seterrOperand1WithConversion(String metricMultiplier)
		{
			err_operand1.convertMeasuredValue(metricMultiplier);
		}
		void setOperand1PreviousValue(String metricMultiplier)
		{
			operand1.setPreviousValue(metricMultiplier);
		}
		void seterrOperand1PreviousValue(String metricMultiplier)
		{
			err_operand1.convertMeasuredValue(metricMultiplier);
		}
		...
		{
			System.out.println("setOperand2WithConversion: "+metricMultiplier);
			operand2.convertMeasuredValue(metricMultiplier);
		}
		
		void seterrOperand2WithConversion(String metricMultiplier)
		{
			err_operand2.convertMeasuredValue(metricMultiplier);
		}
		
		void setOperand2PreviousValue(String metricMultiplier)
		{
			operand2.setPreviousValue(metricMultiplier);
		}
		
		void seterrOperand2PreviousValue(String metricMultiplier)
		{
			err_operand2.setPreviousValue(metricMultiplier);
		}
...
//			return Double.toString(Math.round(i2*10000000000.0)/10000000000.0); // this cast is used to round off to 10 decimal places, we can extend or decrease the zeros as per the precision req.
		...
		public String division() 
		{
			...
			return result.enhancedToString(); // else clause of this conditional block
//			double i2 = Double.parseDouble(result.toString()); // this casts the result to string using the toString() method and then we cast it to Double again to use round operation
//			return Double.toString(Math.round(i2*10000000000.0)/10000000000.0); // this cast is used to round off to 10 decimal places, we can extend or decrease the zeros as per the precision req.
		}
