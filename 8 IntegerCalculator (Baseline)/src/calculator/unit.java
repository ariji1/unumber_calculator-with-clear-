...
public class unit {
	...
	boolean checkIfValidForMultiplication(unit that) {
		...
		case 4:
			switch(that.unitSpecifier) {
//			case 4: this.metricMultiplier = ""
			case 4: this.metricMultiplier = "1.0"; that.metricMultiplier = "1.0"; resultUS = 23; return true;
	...
	/* This works for meters to meter^1/2, we need to add more cases, if we want to add more units for square root */
	
	boolean checkforsqrt()
	{
		if(this.unitSpecifier == 0)
		{
			return true;
		}
		switch(this.unitSpecifier)
		{
		case 1: this.metricMultiplier = "1.0";resultUS = 23; return true;
		case 22: this.metricMultiplier = "1.0";resultUS = 4;return true;
	...
	unit getResultUnitAfterSquareroot()
	{
		return new unit(resultUS);
	}
